        ...
        rules: [
          {
            ...
            annotations: {
              description: 'Pod {{ $labels.namespace }}/{{ $labels.pod }} CPU utilization is below 30% for 24h.',
          ...
          },
          {
            ...
            annotations: {
              description: 'Pod {{ $labels.namespace }}/{{ $labels.pod }} memory utilization is below 30% for 24h.',
              summary: 'Pod memory is underutilized.',
            },
            expr: |||
              avg_over_time((
                100 * sum(container_memory_working_set_bytes{container!="POD"}) by (namespace,pod)
          ...
          },
          {
            ...
            annotations: {
              description: 'Pod {{ $labels.namespace }}/{{ $labels.pod }} CPU utilization is above 80% for 24h.',
          ...
          },
          {
            ...
            annotations: {
              description: 'Pod {{ $labels.namespace }}/{{ $labels.pod }} memory utilization is above 80% for 24h.',
